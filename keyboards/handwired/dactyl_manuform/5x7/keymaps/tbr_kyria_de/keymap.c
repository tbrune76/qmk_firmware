...
[_NUM] = LAYOUT(  // Numpad
    _______,    _______,    _______,    _______,    _______,    _______,    _______,                            _______,    _______,    _______,    _______,    _______,    _______,    _______,
    _______,    KC_PGUP,    KC_HOME,    KC_UP,      KC_END,     _______,    _______,                            _______,    DE_EQL,     DE_7,       DE_8,       DE_9,       DE_PLUS,    DE_ASTR,
    _______,    KC_PGDN,    KC_LEFT,    KC_DOWN,    KC_RIGHT,   _______,    _______,                            _______,    DE_DOT,     GU_4,       AL_5,       CT_6,       SH_MINS,    DE_SLSH,
    _______,    _______,    KC_VOLD,    KC_MUTE,    KC_VOLU,    _______,                                                    DE_0,       DE_1,       DE_2,       DE_3,       DE_LPRN,    DE_RPRN,
    _______,    _______,    _______,    _______,                                                                                                    _______,    _______,    _______,    _______,
                                                    _______,    _______,                                                    _______,    _______,
                                                                            _______,    _______,    _______,    _______,
                                                                            _______,    _______,    _______,    _______),
